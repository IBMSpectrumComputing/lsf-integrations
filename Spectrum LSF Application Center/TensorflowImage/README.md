...
8). label_image.py
   ...
   b). The output_graph.pb and output_labels.txt are generated by the retrain.py script. Copy
      output_graph.pb and output_labels.txt to the MLDL_TOP/imagenet and make these 2 files readable by all. For example
...
11). Download images for the Classify_Directory_Of_Images submission template
   ...
   Note, copy the Classify_Directory_Of_Images to the appropriate LSF Application Directory.
