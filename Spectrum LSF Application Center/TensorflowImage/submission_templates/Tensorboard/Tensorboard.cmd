...
# call Tensorboard wrapper script to generate html output to access Tensorboard URL
COMMANDTORUN=tensorboard.sh
...
# add the LOGDIR 
if [ "x$LOGDIR" != "x" ] ; then
	#OTHER_OPT="$OTHER_OPT --logdir $LOGDIR"
	OTHER_OPT="$OTHER_OPT $LOGDIR"
fi

# add the PORT 
#if [ "x$PORT" != "x" ] ; then
#	#OTHER_OPT="$OTHER_OPT --port $PORT"
#	OTHER_OPT="$OTHER_OPT $PORT"
#fi
