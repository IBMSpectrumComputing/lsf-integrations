...
COMMANDTORUN="$MLDL_SCRIPTS/main.py" 
OTHER_OPT="" 
#APP_PROFILE=powerai
...
# Example: --epochs=2 --batch-size=16
# add NUM_EPOCHS 
if [ "x$NUM_EPOCHS" != "x" ] ; then
	OTHER_OPT="$OTHER_OPT --epochs=$NUM_EPOCHS"
fi
  
# add BATCH_SIZE 
if [ "x$BATCH_SIZE" != "x" ] ; then
	OTHER_OPT="$OTHER_OPT --batch-size=$BATCH_SIZE"
fi
